...
return [
    ...
    */
    ...
    'middleware' => [
        ...
        'timer' => env('SWEET_ALERT_MIDDLEWARE_ALERT_CLOSE_TIME', 2500),
    ...
    */
    ...
    'confirm_delete_confirm_button_text' => env('SWEET_ALERT_CONFIRM_DELETE_CONFIRM_BUTTON_TEXT', 'Hapus!'),
    'confirm_delete_confirm_button_color' => env('SWEET_ALERT_CONFIRM_DELETE_CONFIRM_BUTTON_COLOR', '#E81500'),
    ...
    'confirm_delete_show_close_button' => env('SWEET_ALERT_CONFIRM_DELETE_SHOW_CLOSE_BUTTON', true),
