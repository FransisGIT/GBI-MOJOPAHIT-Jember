            ...
            !(function () {
                function f() {
                    ...
                    try {
                        n =
                            "function" == typeof l.getEntriesByType
                                ? new URL(
                                      l.getEntriesByType("navigation")[0].name
                                  ).pathname
                                : b
                                ? new URL(b).pathname
                    ...
                    return (
                        ...
                        C &&
                            ((r.lcp =
                                C.lcp && void 0 !== C.lcp.value
                                    ? C.lcp
                                    : r.lcp),
                            (r.fid =
                                C.fid && void 0 !== C.fid.value
                                    ? C.fid
                                    : r.fid),
                            (r.cls =
                                C.cls && void 0 !== C.cls.value
                                    ? C.cls
                                    : r.cls)),
                        r
                    );
                ...
                function d(r) {
                    var o = l.timing,
                        ...
                        p = {
                            ...
                            si: g ? g.si : 0,
                            startTime:
                                l.timeOrigin || (o ? o.navigationStart : 0),
                            versions: {
                                fl: g ? g.version : "",
                                js: "2021.12.0",
                                timings: 1,
                            ...
                            O = function (e) {
                                ...
                                if (t && t.sources && t.sources.length) {
                                    var n = t.sources.reduce(function (e, t) {
                                        return e.node &&
                                            e.previousRect.width *
                                                e.previousRect.height >
                                                t.previousRect.width *
                                                    t.previousRect.height
                                            ? e
                                            : t;
                                    });
                                    if (n) return n;
