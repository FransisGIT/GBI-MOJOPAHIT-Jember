            ...
            return (
                        ...
                        if (o.length) {
                            ...
                            if (g.test(e)) {
                                ...
                                r.month
                                    ...
                                    ? (b = t
                                          .shortMonths(n)
                                          .indexOf(v[r.shortMonth]))
                                    : r.longMonth &&
                                      (b = t
                                          .longMonths(n)
                                          .indexOf(v[r.longMonth]));
                ...
                (t.prototype.diff = function (t, e) {
                    ...
                    switch (e) {
                        ...
                        case "days":
                            return Math.round(
                                (this.timestamp() - t.getTime()) / 864e5
                            );
                        case "month":
                        case "months":
                    }
        ...
        var n,
            ...
            s =
                ...
                function () {
                    ...
                    for (e = 0; e < i; e++)
                        for (
                            var s = arguments[e], r = 0, a = s.length;
                            r < a;
                            r++, o++
                        )
                            n[o] = s[r];
            ...
            h = (function (t) {
                ...
                return (
                    ...
                    (e.prototype.onClick = function (t) {
                        ...
                        if (
                            ...
                            if (this.shouldShown(e)) this.show(e);
                                ...
                                e.closest("." + l.litepicker) ||
                                !this.isShowning()
                            ) {
                                if (this.isSamePicker(e))
                                    if (
                                        (this.emit("before:click", e),
                                        this.preventClick)
                                    )
                                        this.preventClick = !1;
                                    else {
                    ...
                    (e.prototype.shouldAllowMouseEnter = function (t) {
                        return (
                            !this.options.singleMode &&
                            !t.classList.contains(l.isLocked)
                        );
                    }),
                    ...
                    (e.prototype.onMouseEnter = function (t) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    ("function" ==
                                        typeof this.options.tooltipNumber &&
                                        (h = this.options.tooltipNumber.call(
                                            this,
                                            h
                                        )),
                                    h > 0)
    ...
    function (t, e, i) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
            (e.findNestedMonthItem = function (t) {
                for (
                    var e = t.parentNode.childNodes, i = 0;
                    i < e.length;
                    i += 1
                ) {
                ...
                return (
                    ...
                    (e.prototype.renderMonth = function (t, e) {
                        ...
                        if (this.options.dropdowns.years) {
                            ...
                            if (t.getFullYear() > y)
                                ((u = document.createElement("option")).value =
                    ...
                    (e.prototype.renderDay = function (t) {
                        ...
                        return (
                            (e.tabIndex = e.classList.contains("is-locked")
                                ? -1
                                : 0),
                    ...
                    (e.prototype.renderFooter = function () {
                        ...
                        if (
                            ...
                            t.querySelector(
                                "." + a.previewDateRange
                            ).innerHTML = "" + e + this.options.delimiter + i;
                        }
    ...
    function (e, t, n) {
        ...
        Litepicker.add("keyboardnav", {
            init: function (e) {
                ...
                function n(e, t, n) {
                    var r = Array.from(
                            e.querySelectorAll('.day-item[tabindex="2"]')
                        ),
                        o = r.indexOf(t);
    ...
    function (e, t, n) {
        ...
        Litepicker.add("mobilefriendly", {
            init: function (e) {
                ...
                function l() {
                    "portrait" === a()
                        ? ((e.options.numberOfMonths = 1),
                          (e.options.numberOfColumns = 1))
                        : ((e.options.numberOfMonths = 2),
                    ...
                    s = function (t) {
                        if (e.xTouchDown && e.yTouchDown) {
                            var n = t.touches[0].clientX,
                                ...
                                u = "",
                                d = Array.from(
                                    e.ui.querySelectorAll(".month-item")
                                );
                            if (a) {
                                var p = e.DateTime(
                                        e.ui.querySelector(".day-item").dataset
                                            .time
                                    ),
                                    f = Number(
                                        "".concat(1 - Math.abs(i) / 100)
                                    ),
                                    m = 0;
                                if (i > 0) {
                                    (m = -Math.abs(i)),
            ...
            init: function (e) {
                ...
                if (!Object.keys(t.customRanges).length) {
                    ...
                    t.customRanges =
                        ...
                        o(r, t.customRangesLabels[2], [
                            i.clone().subtract(6, "day"),
                            i,
                        ]),
                        o(r, t.customRangesLabels[3], [
                            i.clone().subtract(29, "day"),
                            i,
                        ]),
                        o(
                            r,
                ...
                e.on("render", function (n) {
                    ...
                    (r.className = "container__predefined-ranges"),
                        ...
                        Object.keys(t.customRanges).forEach(function (a) {
                            ...
                            (i.innerText = a),
                                (i.tabIndex =
                                    n.dataset.plugins.indexOf("keyboardnav") >=
                                    0
                                        ? 1
                                        : -1),
                                ...
                                i.addEventListener("click", function (n) {
                                    ...
                                    if (r) {
                                        var a = e.DateTime(
                                                Number(r.dataset.start)
                                            ),
                                            o = e.DateTime(
                                                Number(r.dataset.end)
                                            );
                                        t.autoApply
        ...
        function c(e, t) {
            for (var n = 0; n < e.length; n++) {
                ...
                if (o) {
                    ...
                    for (var a = []; l < r.parts.length; l++)
                        a.push(v(r.parts[l], t));
            ...
            init: function (e) {
                ...
                e.on("before:show", function () {
                    ...
                    e.on("before:click", function (n) {
                        if (n.classList.contains("day-item")) {
                            ...
                            n.classList.contains("is-selected")
                                ? ((e.preMultipleDates =
                                      e.preMultipleDates.filter(function (e) {
                                          return e !== r;
                                      })),
                                  e.emit("multiselect.deselect", e.DateTime(r)))
                                : ((e.preMultipleDates[
                                      e.preMultipleDates.length
                                  ] = r),
                    ...
                    e.on("button:apply", function () {
                        e.multipleDates = r(e.preMultipleDates).sort(function (
                            e,
                            t
                        ) {
                            return e - t;
