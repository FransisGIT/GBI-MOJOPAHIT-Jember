...
@section('content')
    ...
    <div class="container-xl px-4 mt-n10">
        ...
        <div class="card lift order-1">
            <div class="container">
                <div class="card-body">
                    <form action="/kelola-renungan/{{ $data->id }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <div class="mt-4">
                            <figure class="d-flex justify-content-center text-center">
                                <img class="img-thumbnail img-fluid w-50 " src="{{ asset('/storage/' . $data->gambar) }}"
                                    id="edit-preview" />
                            </figure>
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-joined input-group-solid ">
                                    ...
                                    <input class="form-control ps-0" type="file" placeholder="Upload Gambar"
                                        ...
                                        value="{{ $data->gambar }}" oninput="editPreview()" />
                                </div>
                            </div>
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="mt-4">
                            ...
                            <input class="form-control form-control-solid" name="dibuat" id="custom-date-input"
                                placeholder="Masukkan Tanggal Renungan Dibuat" value="{{ $data->dibuat }}">
                        </div>
                        <div class="mt-4">
                            <label>Isi Renungan</label>
                            <textarea name="isi_renungan" id="deskripsi" name="isi_renungan" cols="30" rows="10">{{ $data->isi_renungan }}</textarea>
                        </div>
                    </form>
                </div>
            </div>
